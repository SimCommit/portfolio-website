  ...
  myProjects: Project[] = [
    {
      ...
      posterUrl: "./assets/img/portfolio/project/donate-poster-10.png",
      videoUrl: "./assets/img/portfolio/project/donation-preview-video-8.mp4",
      cogwheelUrl: "./assets/img/portfolio/project/cogwheel-180.svg",
      learning: "main-page.portfolio.project.learning-donation-page",
      emojiUrl: "./assets/img/icons/project/unyt-logo.svg",
    ...
    },
    {
      ...
      posterUrl: "./assets/img/portfolio/project/el-pollo-loco-poster-1.png",
    ...
    },
    {
      ...
      backgroundColor: "#FF834F",
      learningBgColor: "#679AAC",
      posterUrl: "./assets/img/portfolio/project/pokedex-poster-1.png",
